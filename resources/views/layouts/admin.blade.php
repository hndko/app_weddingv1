...
<head>
    ...
    <meta name="description" content="Laravel {{ config('app.name') }} 2">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {{ Nav::isRoute('weddings.*') }}">
                <a class="nav-link" href="{{ route('weddings.index') }}">
                    <i class="fas fa-fw fa-ring"></i>
                    <span>{{ __('Weddings') }}</span></a>
            </li>
            <li class="nav-item {{ Nav::isRoute('grooms.*') }}">
                <a class="nav-link" href="{{ route('grooms.index') }}">
                    <i class="fas fa-fw fa-male"></i>
                    <span>{{ __('Pengantin Pria') }}</span></a>
            </li>
            <li class="nav-item {{ Nav::isRoute('brides.*') }}">
                <a class="nav-link" href="{{ route('brides.index') }}">
            ...
            <li class="nav-item {{ Nav::isRoute('messages.*') }}">
