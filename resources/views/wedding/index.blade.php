...
<head>
    ...
    <meta property="og:image" content="assets/img/kita.png">
    ...
    <link href="assets/css/material-components-web.css" rel="stylesheet">


    <!-- Modernizr JS -->
    <script src="assets/js/js-modernizr-2.6.2.min.js"></script>
    <!-- FOR IE9 below -->

    <link rel="stylesheet" href="assets/css/ket2.css">
...
<body>
    ...
    <!-- ============== MUSIK =============== -->
    <audio loop="true" src="assets/musik/musik.mp3" id="audio"></audio>
    <!-- ============== MUSIK =============== -->
    ...
    <div style="display: none;" id="page"><a href="#"
            ...
            <div class="container">
                ...
                <div class="couple-wrap animate-box fadeInUp animated-fast">
                    <div class="couple-half">
                        <div class="groom"> <img src="assets/img/bride.png?nocache=1440" alt="groom"
                    ...
                    <div class="couple-half">
                        <div class="bride"> <img src="assets/img/groom.png?nocache=1440" alt="groom"
                                class="img-responsive">
                        </div>
                        ...
                        <ul class="timeline animate-box fadeInUp animated-fast">
                            ...
                            <li class="timeline-inverted animate-box fadeInUp animated-fast">
                                <div class="timeline-badge"
                                    style="background-color:#304058; background-image:url(assets/img/couple-1.png);">
                                </div>
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        <h3 class="timeline-title">Pertama bertemu</h3>
                                        <img src="assets/img/album1.png" alt="img" class="timeline-img">
                            ...
                            <li class="animate-box fadeInUp animated-fast">
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        ...
                                        <img src="assets/img/album2.png" alt="img" class="timeline-img">
                            ...
                            <li class="timeline-inverted animate-box fadeInUp animated-fast">
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        ...
                                        <img src="assets/img/album3.png" alt="img" class="timeline-img"><span
                                            class="date">1
                                            Mei 2020</span>
                                    </div>
                                    <div class="timeline-body">
                            ...
                            <li class="animate-box fadeInUp animated-fast">
                                ...
                                <div class="timeline-panel">
                                    <div class="timeline-heading">
                                        ...
                                        <img src="assets/img/album4.png" alt="img" class="timeline-img">
                    ...
                    <div class="col-md-12">
                        <ul id="fh5co-gallery-list">
                            ...
                            <li class="one-third animate-box fadeIn animated-fast" data-animate-effect="fadeIn"
                                style="background-image: url(assets/img/album1.png);">
                                <a href="assets/img/album1.png" data-lightbox="roadtrip">
                            ...
                            <!-- GET DATA -->
                            <li class="one-third animate-box fadeIn animated-fast" data-animate-effect="fadeIn"
                                style="background-image: url(assets/img/album2.png);">
                                <a href="assets/img/album2.png" data-lightbox="roadtrip">
                                    <div class="case-studies-summary"> <span></span>
                                        <h2></h2>
                                    </div>
                                </a>
                            ...
                            <!-- GET DATA -->
                            <li class="one-third animate-box fadeIn animated-fast" data-animate-effect="fadeIn"
                                style="background-image: url(assets/img/album3.png);">
                                <a href="assets/img/album3.png" data-lightbox="roadtrip">
                                    <div class="case-studies-summary"> <span></span>
                                        <h2></h2>
                                    </div>
                                </a>
                            ...
                            <!-- GET DATA -->
                            <li class="one-third animate-box fadeIn animated-fast" data-animate-effect="fadeIn"
                                style="background-image: url(assets/img/album4.png);">
                                <a href="assets/img/album4.png" data-lightbox="roadtrip">
                                    <div class="case-studies-summary"> <span></span>
                                        <h2></h2>
                                    </div>
                                </a>
                            ...
                            <!-- GET DATA -->
                            <li class="one-third animate-box fadeIn animated-fast" data-animate-effect="fadeIn"
                                style="background-image: url(assets/img/album5.png);">
                                <a href="assets/img/album5.png" data-lightbox="roadtrip">
                                    <div class="case-studies-summary"> <span></span>
                                        <h2></h2>
                                    </div>
                                </a>
                            ...
                            <!-- GET DATA -->
                            <li class="one-third animate-box fadeIn animated-fast" data-animate-effect="fadeIn"
                                style="background-image: url(assets/img/album6.png);">
                                <a href="assets/img/album6.png" data-lightbox="roadtrip">
                                    <div class="case-studies-summary"> <span></span>
                                        <h2></h2>
                                    </div>
                                </a>
        ...
        <footer>
            <p> &copy; Copyright 2022, <a href="">MSN PRODUCTION - PT. Mulia Sejati Nusantara.</a> All Rights
                Reserved
            </p>
        </footer>
    ...
    <!-- countTo -->
    <script src="assets/js/js-jquery.countTo.js"></script>
    ...
    <script src="assets/js/js-simplyCountdown.js"></script>
    <!-- Main -->
